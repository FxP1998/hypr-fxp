...
local colors = {
    ...
    base02 = '{{colors.surface_container.default.hex}}', -- Selection
    base03 = '{{colors.on_surface_variant.default.hex}}', -- Comments
    base04 = '{{colors.outline.default.hex}}', -- Status Bar FG
    base05 = '{{colors.on_surface.default.hex}}', -- Text
    base06 = '{{colors.on_surface.default.hex}}',
    base07 = '{{colors.inverse_on_surface.default.hex}}',
    base08 = '{{colors.error.default.hex}}', -- Red
    base09 = '{{colors.tertiary.default.hex}}', -- Orange/Peach
    base0A = '{{colors.secondary.default.hex}}', -- Yellow
    base0B = '{{colors.primary.default.hex}}', -- Green/String
    base0C = '{{colors.on_secondary_container.default.hex}}', -- Cyan
    base0D = '{{colors.primary.default.hex}}', -- Blue/Function
    base0E = '{{colors.tertiary_container.default.hex}}', -- Purple
